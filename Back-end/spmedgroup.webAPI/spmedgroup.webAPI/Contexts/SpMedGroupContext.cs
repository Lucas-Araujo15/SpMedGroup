    ...
    public partial class SpMedGroupContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=tcp:senai-gufi.database.windows.net,1433;Initial Catalog=SPMEDGROUP;Persist Security Info=False;User ID=lucao_o;Password=Lu418891104@132;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
